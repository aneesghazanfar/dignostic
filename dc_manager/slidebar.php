...
<div class="sidebar">
    <ul class="nav flex-column">
        ...
        <li class="nav-item"><a class="nav-link" href="./reports.php">Upload Patient's Reports/Billing Invoices</a></li>
        <li class="nav-item"><a class="nav-link" href="./patients_massages.php">Patient's Messages/Feedback</a></li>
        <li class="nav-item"><a class="nav-link" href="./view_patient_rating.php">Patient's Rating</a></li>
    </ul>
</div>
