...
<body>
    ...
    <div class="content">
        ...
        <table id="data_table" class="table table-striped">
            ...
            <tbody>
                <?php
                $sql1 = "SELECT td.* FROM test_detail td , users u , diagnostic_center dc WHERE td.center_id = dc.id AND dc.user_id = u.id AND u.id = ".$_SESSION["user_id"]."";
                    ...
                    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>" class="mt-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category" required>
                                ...
                                $sql = "SELECT tc.* FROM test_categories tc , users u , diagnostic_center dc, center_test_cat ctc WHERE tc.id = ctc.test_type AND ctc.center_id = dc.id AND dc.user_id = u.id AND u.id = ".$_SESSION["user_id"];
